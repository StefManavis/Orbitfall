...
2. Open Unity Hub.
3. Click **Add project**.
4. Select the cloned `Orbitfall` folder.
5. Open the project in Unity.

## How to Play / Test

1. Open the main Unity scene from the `Assets/Scenes` folder.
2. Press **Play** in the Unity editor.
3. Use mouse input in the editor to test movement.
4. Clear enemies in each room to trigger upgrade selection and progress to the next room.
...
**Stefanos Manavis**  
GitHub: [github.com/StefManavis](https://github.com/StefManavis)
